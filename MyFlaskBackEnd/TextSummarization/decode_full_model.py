...
def decode(save_path, model_dir, split, batch_size,
    ...
    start = time()
    # setup model
    with codecs.open(join(model_dir, 'meta.json'), encoding="utf-8") as f:
    ...
    with codecs.open(join(save_path, 'log.json'), 'w', encoding="utf-8") as f:
    ...
    with torch.no_grad():
        for i_debug, raw_article_batch in enumerate(loader):
            ...
            for j, n in ext_inds:
                ...
                with codecs.open(join(save_path, 'output/{}.dec'.format(i)),
