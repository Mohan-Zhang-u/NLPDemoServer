...
# from retriever.subutils import tokenizers
# import retriever.subutils as retriever
...
# def main_func(db_path, out_dir, ngram, hash_size, tokenizer, num_workers):
# def main_func(db_path, out_dir, ngram, hash_size, tokenizer, num_workers):
