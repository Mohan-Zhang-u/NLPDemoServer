...
#  --output_dir=fine_tuned/BERT_BASE/MRPC_output/
...
python my_run_classifier.py \
 ...
 --learning_rate=2e-5 \
 --num_train_epochs=3.0 \
 --output_dir=fine_tuned/BERT_BASE/"$task_name"_output/
...
#
# for task_name in "MNLI" "QNLI" "SNLI" "WNLI"; # already: "CoLA" "MNLI" "MRPC" not: "QQP" "RTE" "SST-2" "STS-B"
# do
#    python run_classifier.py \
#  --task_name=xnli \
#  --do_train=true \
